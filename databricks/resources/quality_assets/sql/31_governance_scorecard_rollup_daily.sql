CREATE OR REPLACE VIEW main.governance_maturity.governance_scorecard_dataset_daily AS
SELECT
  report_date,
  dataset_id,
  dataset_name,
...
FROM main.governance_maturity.governance_scorecard_metric_daily
GROUP BY
  report_date,
  dataset_id,
  dataset_name,
...
CREATE OR REPLACE VIEW main.governance_maturity.governance_scorecard_domain_daily AS
SELECT
  report_date,
  domain_name,
...
FROM main.governance_maturity.governance_scorecard_dataset_daily
GROUP BY
  report_date,
  domain_name;
